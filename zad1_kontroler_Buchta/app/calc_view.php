...
<form action="<?php print(_APP_URL);?>/app/calc.php" method="post">
	...
	<input id="id_kwota" type="text" name="kwota" value="<?php isset($x) ? print($x): ''; ?>" /><br />
	<label for="id_lat">ile lat? </label>
	<input id="id_lat" type="text" name="lat" value="<?php isset($y) ? print($y): ''; ?>" /><br />
		<label for="id_procent">ile procent? </label>
	<input id="id_procent" type="text" name="procent" value="<?php isset($z) ? print($z): ''; ?>" /><br />
